 ...
 */
@define("vc-canvas")
export class Canvas extends VcComponent {
    ...
    public readonly screenManager: DocumentManager;
    ...
    public remove(): this {
        super.remove();
        this.screenManager.currentType = DocumentScreens.home;
        return this;
    }

    public get scale() {
        if (this.screenManager.currentType !== DocumentScreens.canvas) return 1;
